...
config :smart_trash_bin_server, SmartTrashBinServer.Repo,
  ...
  password: "",
  database: "smart_trash_bin_server_dev",
  hostname: "localhost",
...
config :smart_trash_bin_server, SmartTrashBinServer.Mailer, adapter: Bamboo.LocalAdapter
...
config :smart_trash_bin_server, SmartTrashBinServerWeb.Endpoint,
  ...
  live_reload: [
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/smart_trash_bin_server_web/(live|views|components)/.*(ex|sface|js)$",
      ~r"lib/smart_trash_bin_server_web/templates/.*(eex)$",
      ~r"priv/catalogue/.*(ex)$"
    ]
  ]
